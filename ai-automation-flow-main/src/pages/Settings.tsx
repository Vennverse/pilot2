...
const Settings = () => {
  ...
  >("all");
  const [isCustomIntegrationModalOpen, setIsCustomIntegrationModalOpen] =
    useState(false);
  const [editingCustomIntegration, setEditingCustomIntegration] =
  ...
  const filteredProviders = providers.filter((provider) => {
    ...
    const matchesAuth =
      authFilter === "all" || provider.auth_type === authFilter;
    ...
    try {
      ...
      const mockProviders: Provider[] = [
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "get", name: "Get Forecast" }],
        },
        {
          id: "mailchimp",
          name: "mailchimp",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "add_subscriber", name: "Add Subscriber" }],
        },
        {
          id: "claude",
          name: "claude",
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "pay", name: "Create Customer" }],
        },
        {
          id: "twilio",
          name: "twilio",
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "upload", name: "Upload Video" }],
        },
        {
          id: "whatsapp",
          name: "whatsapp",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "msg", name: "Send Message" }],
        },
        {
          id: "woocommerce",
          name: "woocommerce",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "order", name: "Create Order" }],
        },
        {
          id: "zendesk",
          name: "zendesk",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "support", name: "Create Ticket" }],
        },
        {
          id: "custom_tool",
          name: "custom_tool",
          display_name: "Custom Integration (Webhook)",
          icon: "Link",
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "webhook", name: "Trigger Webhook" }],
        },
        {
          id: "custom_api",
          name: "custom_api",
          display_name: "Custom API Tool (Auth Required)",
          icon: "ShieldCheck",
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "call", name: "Call API" }],
        },
        {
          id: "ai_marketing",
          name: "ai_marketing",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "copy", name: "Generate Copy" }],
        },
        {
          id: "groq",
          name: "groq",
        ...
        // SMS/Voice
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "send_sms", name: "Send SMS" }],
        },
        {
          id: "bandwidth",
          name: "bandwidth",
        ...
        // Payment Processors
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_transaction", name: "Create Transaction" }],
        },
        {
          id: "razorpay",
          name: "razorpay",
        ...
        // Accounting/Finance
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_invoice", name: "Create Invoice" }],
        },
        {
          id: "xero",
          name: "xero",
        ...
        // Marketing Automation
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "add_contact", name: "Add Contact" }],
        },
        {
          id: "convertkit",
          name: "convertkit",
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_subscriber", name: "Create Subscriber" }],
        },
        {
          id: "omnisend",
          name: "omnisend",
          display_name: "Omnisend",
          icon: "Mail",
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "add_contact", name: "Add Contact" }],
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_profile", name: "Create Profile" }],
        },
        {
          id: "brevo",
          name: "brevo",
        ...
        // Social Media Management
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_post", name: "Create Post" }],
        },
        {
          id: "hootsuite",
          name: "hootsuite",
        ...
        // Customer Support
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_ticket", name: "Create Ticket" }],
        },
        {
          id: "helpscout",
          name: "helpscout",
        ...
        // Project Management
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_todo", name: "Create Todo" }],
        },
        {
          id: "wrike",
          name: "wrike",
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "add_row", name: "Add Row" }],
        },
        {
          id: "notion_api",
          name: "notion_api",
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "insert_row", name: "Insert Row" }],
        },
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "write_data", name: "Write Data" }],
        },
        {
          id: "mongodb",
          name: "mongodb",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "insert_document", name: "Insert Document" }],
        },
        {
          id: "airtable_api",
          name: "airtable_api",
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "put_item", name: "Put Item" }],
        },
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "send_log", name: "Send Log" }],
        },
        {
          id: "papertrail",
          name: "papertrail",
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "report_error", name: "Report Error" }],
        },
        {
          id: "honeybadger",
          name: "honeybadger",
        ...
        // CI/CD
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "trigger_pipeline", name: "Trigger Pipeline" }],
        },
        {
          id: "travis_ci",
          name: "travis_ci",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "trigger_build", name: "Trigger Build" }],
        },
        {
          id: "jenkins",
          name: "jenkins",
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "trigger_workflow", name: "Trigger Workflow" }],
        },
        {
          id: "gitlab_ci",
          name: "gitlab_ci",
        ...
        // Content Management
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_entry", name: "Create Entry" }],
        },
        {
          id: "strapi",
          name: "strapi",
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_article", name: "Create Article" }],
        },
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_submission", name: "Create Submission" }],
        },
        {
          id: "wufoo",
          name: "wufoo",
        ...
        },
        {
          id: "formspree",
          name: "formspree",
          display_name: "Formspree",
          icon: "FileText",
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "submit_form", name: "Submit Form" }],
        },
        ...
        // Video/Media
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "upload_video", name: "Upload Video" }],
        },
        {
          id: "youtube",
          name: "youtube",
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "upload_image", name: "Upload Image" }],
        },
        {
          id: "imgur",
          name: "imgur",
        ...
        // Maps/Location
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "geocode", name: "Geocode Address" }],
        },
        {
          id: "mapbox",
          name: "mapbox",
        ...
        // Translation
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "translate", name: "Translate Text" }],
        },
        {
          id: "google_translate",
        ...
        // OCR/Image Processing
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "extract_text", name: "Extract Text" }],
        },
        {
          id: "aws_textract",
          name: "aws_textract",
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "analyze_image", name: "Analyze Image" }],
        },
        ...
        // Webhooks/API
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "trigger_webhook", name: "Trigger Webhook" }],
        },
        {
          id: "make",
          name: "make",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "trigger_scenario", name: "Trigger Scenario" }],
        },
        {
          id: "n8n",
          name: "n8n",
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "trigger_applet", name: "Trigger Applet" }],
        },
        ...
        // Time Tracking
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_time_entry", name: "Create Time Entry" }],
        },
        {
          id: "harvest",
          name: "harvest",
        ...
        // HR/Recruiting
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_employee", name: "Create Employee" }],
        },
        {
          id: "workday",
          name: "workday",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_worker", name: "Create Worker" }],
        },
        {
          id: "greenhouse",
          name: "greenhouse",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_candidate", name: "Create Candidate" }],
        },
        ...
        // Document Management
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "send_envelope", name: "Send Envelope" }],
        },
        {
          id: "hello_sign",
          name: "hello_sign",
          ...
          oauth_config: {},
          actions: [
            { id: "send_signature_request", name: "Send Signature Request" },
          ],
        },
        {
          id: "pandadoc",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_document", name: "Create Document" }],
        },
        ...
        // Shipping/Logistics
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_shipment", name: "Create Shipment" }],
        },
        {
          id: "easypost",
          name: "easypost",
        ...
        // Real Estate
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "get_property", name: "Get Property" }],
        },
        {
          id: "realtor",
          name: "realtor",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "search_listings", name: "Search Listings" }],
        },
        ...
        // Weather/Environment
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "get_weather", name: "Get Weather" }],
        },
        {
          id: "weather_api",
          name: "weather_api",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "get_forecast", name: "Get Forecast" }],
        },
        ...
        // News/Content
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "get_articles", name: "Get Articles" }],
        },
        {
          id: "rss",
          name: "rss",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "parse_feed", name: "Parse Feed" }],
        },
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "create_order", name: "Create Order" }],
        },
        ...
        // AI/ML Services
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "run_model", name: "Run Model" }],
        },
        {
          id: "huggingface",
          name: "huggingface",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "run_inference", name: "Run Inference" }],
        },
        {
          id: "stability_ai",
          name: "stability_ai",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "generate_image", name: "Generate Image" }],
        },
        {
          id: "midjourney_api",
          name: "midjourney_api",
        ...
        },
        {
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "text_to_speech", name: "Text to Speech" }],
        },
        {
          id: "assemblyai",
          name: "assemblyai",
          ...
          auth_type: "api_key",
          oauth_config: {},
          actions: [{ id: "transcribe_audio", name: "Transcribe Audio" }],
        },
      ];
  ...
  const handleConnect = async (provider: Provider) => {
    if (provider.auth_type === "api_key") {
      ...
      const redirectUri =
        oauthConfig.redirect_uri || `${window.location.origin}/settings`;
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="flex flex-wrap items-center gap-4 w-full">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <Badge
                    variant={
                      connectionFilter === "connected" ? "default" : "outline"
                    }
                    className="cursor-pointer whitespace-nowrap"
                  ...
                  <Badge
                    variant={
                      connectionFilter === "not_connected"
                        ? "default"
                        : "outline"
                    }
                    className="cursor-pointer whitespace-nowrap"
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2 flex-wrap mb-1">
                            ...
                            {provider.id.startsWith("custom_") && (
                              <Badge
                                variant="secondary"
                                className="text-[10px] h-4 uppercase font-bold tracking-wider"
                              >
                                Custom
                              </Badge>
                            )}
                        ...
                        {provider.id.startsWith("custom_") && (
                          <>
                            ...
                            <Button
                              ...
                              onClick={() => {
                                const customIntegrations: Provider[] =
                                  JSON.parse(
      ...
      <Dialog
        ...
        onOpenChange={(open) =>
          setApiKeyModal({ open, provider: open ? apiKeyModal.provider : null })
        }
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              Connect {apiKeyModal.provider?.display_name}
            </DialogTitle>
            <DialogDescription>
          ...
          <DialogFooter>
            <Button
              variant="ghost"
              onClick={() => setApiKeyModal({ open: false, provider: null })}
            >
              Cancel
            </Button>
            <Button
