  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <Link to="/" className="flex items-center gap-2 mb-8">
            ...
            <span className="text-2xl font-bold">FlowPilot</span>
          </Link>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-secondary/30 relative overflow-hidden">
        ...
        >
          <div className="w-20 h-20 rounded-2xl bg-primary/20 flex items-center justify-center mx-auto mb-6 glow">
            <Zap className="w-10 h-10 text-primary" />
          </div>
          <h2 className="text-3xl font-bold mb-4">
            Automate with <span className="text-gradient">AI</span>
          </h2>
          <p className="text-muted-foreground text-lg">
            Describe your workflow in plain English and let our AI handle the rest. 
            No coding required.
          </p>
        </motion.div>
      </div>
